" Control de buffers con cursores
map <Right> :bn<cr>
map <Left> :bp<cr>
map <Down> :bd<cr>
let mapleader=" "
...
set hlsearch
  ...
  function! CurDir()
     let curdir = substitute(getcwd(), '/home/cbarroso/', "~/", "g")
     return curdir
  endfunction
...
let g:vimwiki_list = [{'path': '~/proyectos/gtd', 'ext': '.asc'} ]
let g:vimwiki_folding = 1
"\ {'path': '~/proyectos/gtd/', 'ext': '.gpg'},

let g:GPGDefaultRecipients = ['cjbarroso@gmail.com', 'software@starbene.com']
let g:GPGDebugLevel = 0

let g:journal_directory = "~/proyectos/gtd/journal"
map <Leader>s :nohlsearch<cr>
" ticler de mañana
nmap <Leader>kn :sp `ticresolv +1`<cr>
" ticler de ayer
nmap <Leader>kp :sp `ticresolv -1`<cr>
...
" para reabrir el archivo actual, pero como root
